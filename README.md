...
|---|---|---|
| **MSc thesis** | Ingegneria Meccanica (LM-33) | about 6 months |
| **BSc thesis** | Engineering Management (L-8) | about 3 months |
| **Project work** | within the two courses below | a few weeks |
| **Laboratory experience** | within the two courses below | a few days to a few weeks |

Project work and laboratory experiences are shorter, self-contained pieces tied to a course. They are a good way to find out whether a thesis with me is something you'd enjoy, and several have grown into one.
...
See **[getting-started.md](getting-started.md)** for the Python environment, git basics, and the tools used across these projects.

## What you can expect from me

- A topic with a scope that actually fits the time you have
- Regular meetings — usually every two weeks, more often around deadlines
- Access to the instrumentation, data and code the work needs
- Help turning good results into a publication, where that makes sense

## What I expect from you

- Basic Python. You don't need to be a programmer, but you will write code.
- Your work kept in a git repository, not in a folder of `final_v3_REAL.py` files. I'll set this up with you.
